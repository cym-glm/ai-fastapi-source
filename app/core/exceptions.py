...
class ErrorCode(IntEnum):
    ...
    LLM_API_KEY_MISSING = 50010
    LLM_MODEL_NOT_FOUND = 50011
    LLM_RATE_LIMITED = 50012
    LLM_TIMEOUT = 50013
    LLM_RESPONSE_PARSE_FAILED = 50014
    LLM_PROVIDER_ERROR = 50015
    STRUCTURED_OUTPUT_PARSE_FAILED = 50016
